...
2. Analizar la dinámica de poblaciones marinas explotadas sobre la base de parámetros de historia de vida y producción de juveniles (reclutamiento)

3. Aplicar métodos empíricos y modelos de evaluación basado en datos de captura y modelos basados en datos de frecuencia de tallas.

4. Evaluar estrategias de explotación mediante simulación a través del enfoque de Evaluación de Estrategias de Manejo.

# Contenidos

1.	Objetivos de manejo, procedimiento de manejo, y evaluación de estrategias de manejo.
...
4. Modelos de evaluación basados sólo en datos de captura (CMSY, OCOM, otros). 

5. Modelos de evaluación de stock basado en datos de frecuencia de tallas (LBI, LBSPR, otros).
...
El programa de trabajo del curso se puede encontrar [aquí](https://luisacubillos.github.io/curso_sibecorp_evastock_datlim/syllabus.html)
...
A su vez, se necesita instalar el package ```FishLife``` de Thorson (2017, 2020), el cual está disponible en el repositorio [GitHub de James Thorson](https://github.com/James-Thorson-NOAA/FishLife), con el siguiente instrucción:

```{r, eval=FALSE}
devtools::install_github("james-thorson/FishLife")
```

Se necesitará descargar los datos [aquí](https://github.com/LuisACubillos/curso_sibecorp_evastock_datlim/Datos))
